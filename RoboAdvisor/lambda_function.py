    ...
    if age is not None:
        ...
        if age < 0:
            return build_validation_result(
                False,
                "age",
                "Negative age does not make much sense, "
                "please provide a different date of birth.",)
        elif age > 65:
            return build_validation_result(
                False,
                "age",
                "No way you are over 65, "
                "please provide a different date of birth.",)
...
def recommend_portfolio(intent_request):
    ...
    initial_recommendation_dict = {"None":"100% bonds (AGG), 0% equities (SPY)", 
    ...
    initial_recommendation = initial_recommendation_dict[risk_level]
